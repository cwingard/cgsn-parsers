...
if [ $# -ne 5 ]; then
    ...
    echo "(e.g., XEOS1), a flag to indicate if the beacon is subsurface (1), or mounted"
    echo "on the tower (0), and the name of the file with the IMEI number to process."
    echo "     example: $0 ce07shsm D00017 XEOS1 0 300434062471940.log"
    exit 1
fi
PLATFORM=${1,,}
DEPLOY=${2^^}

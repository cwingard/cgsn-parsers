...
./polling.sh 30 "$HARVEST/harvest_superv_cpm.sh $PLATFORM $DEPLOY $assembly superv/cpm1" "$RAW/superv/*.superv.log"
...
./polling.sh 30 "$HARVEST/harvest_pwrsys.sh -f psc $PLATFORM $DEPLOY $assembly psc" "$RAW/pwrsys/*.pwrsys.log"
...
./polling.sh 30 "$HARVEST/harvest_velpt.sh $PLATFORM $DEPLOY $assembly velpt" "$RAW/$dcl/velpt1/*.velpt*.log"
...
./polling.sh 30 "$HARVEST/harvest_superv_dcl.sh $PLATFORM $DEPLOY $assembly superv/$dcl" "$RAW/$dcl/superv/*.superv.log"
./polling.sh 30 "$HARVEST/harvest_adcp.sh -f pd0 $PLATFORM $DEPLOY $assembly adcp" "$RAW/$dcl/$ADCP1/*.adcp*.log"
./polling.sh 30 "$HARVEST/harvest_nutnr.sh -f suna $PLATFORM $DEPLOY $assembly nutnr" "$RAW/$dcl/nutnr/*.nutnr.log"
./polling.sh 30 "$HARVEST/harvest_phsen.sh $PLATFORM $DEPLOY $assembly phsen" "$RAW/$dcl/$PH1/*.phsen*.log"
./polling.sh 30 "$HARVEST/harvest_spkir.sh $PLATFORM $DEPLOY $assembly spkir" "$RAW/$dcl/spkir/*.spkir.log"
./polling.sh 30 "$HARVEST/harvest_velpt.sh $PLATFORM $DEPLOY $assembly velpt" "$RAW/$dcl/velpt2/*.velpt*.log"

dcl="dcl27"  # Data logger for the remaining instruments on the NSIF
./polling.sh 30 "$HARVEST/harvest_superv_dcl.sh $PLATFORM $DEPLOY $assembly superv/$dcl" "$RAW/$dcl/superv/*.superv.log"
./polling.sh 30 "$HARVEST/harvest_ctdbp.sh -f solo $PLATFORM $DEPLOY $assembly ctdbp" "$RAW/$dcl/$CTD1/*.ctdbp*.log"
...
./polling.sh 30 "$HARVEST/harvest_optaa.sh $PLATFORM $DEPLOY $assembly optaa" "$RAW/$dcl/$ACS1/*.optaa*.log"
...
if [ $MFN_FLAG -eq 1 ]; then
    ...
    ./polling.sh 30 "$HARVEST/harvest_superv_dcl.sh $PLATFORM $DEPLOY $assembly superv/$dcl" "$RAW/$dcl/superv/*.superv.log"
    ./polling.sh 30 "$HARVEST/harvest_adcp.sh -f pd0 $PLATFORM $DEPLOY $assembly adcp" "$RAW/$dcl/$ADCP2/*.adcp*.log"
    ./polling.sh 30 "$HARVEST/harvest_pco2w.sh $PLATFORM $DEPLOY $assembly pco2w" "$RAW/$dcl/pco2w/*.pco2w*.log"
    ./polling.sh 30 "$HARVEST/harvest_phsen.sh $PLATFORM $DEPLOY $assembly phsen" "$RAW/$dcl/$PH2/*.phsen*.log"
    ...
    ./polling.sh 30 "$HARVEST/harvest_superv_dcl.sh $PLATFORM $DEPLOY $assembly superv/$dcl" "$RAW/$dcl/superv/*.superv.log"
    ./polling.sh 30 "$HARVEST/harvest_ctdbp.sh -f dosta $PLATFORM $DEPLOY $assembly ctdbp" "$RAW/$dcl/$CTD2/*.ctdbp*.log"
    ./polling.sh 30 "$HARVEST/harvest_optaa.sh $PLATFORM $DEPLOY $assembly optaa" "$RAW/$dcl/$ACS2/*.optaa*.log"

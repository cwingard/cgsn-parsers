...
class Parser(ParserCommon):
    ...
    def _build_parsed_values(self, match):
        ...
        self.data.serial_number.append(str(match.group(1)))
        self.data.sphox_date_time_string.append(str(match.group(2)))
        self.data.sample_number.append(int(match.group(3)))
        self.data.error_flag.append(str(match.group(4)))
        self.data.temperature.append(float(match.group(5)))
        self.data.seawater_ph.append(float(match.group(6)))
        self.data.external_reference.append(float(match.group(7)))
        self.data.pressure.append(float(match.group(8)))
        self.data.salinity.append(float(match.group(9)))
        self.data.conductivity.append(float(match.group(10)))
        self.data.oxygen_concentration.append(float(match.group(11)))
        self.data.internal_humidity.append(float(match.group(12)))
        self.data.internal_temperature.append(float(match.group(13)))

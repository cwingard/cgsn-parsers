...
class Parser(ParserCommon):
    ...
    def _build_parsed_values(self, match):
        ...
        if self.superv_type == 'cpm':
            ...
            self.data.gps_power_state.append(float(match.group(26)))
            self.data.pps_source.append(float(match.group(27)))
        ...
        if self.superv_type == 'stc':
            ...
            self.data.gps_power_state.append(float(match.group(32)))
            self.data.sbd_signal_strength.append(float(match.group(33)))
            self.data.pps_source.append(float(match.group(34)))
            self.data.imm_power_state.append(float(match.group(35)))
